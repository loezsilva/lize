...
class Command(BaseCommand):
    ...
    exams_pks = [
        '654a61f1-2f1b-4a3a-9b4a-91f58d42fe87', 
        '4967155e-3c75-4324-b7a4-e025afe69a2f', 
        '1e9f1486-ff35-44a0-9198-6b8ed9785f91', 
        '0148dca4-39bc-43b1-a351-769f1dd5678d',
    ]
    ...
    def _save_optionanswers_to_parquet(self, queryset, filename):
        ...
        df['exam_name'] = df['exam_name'].str.replace(
                'AVHA - AVALIAÇÃO DE HABILIDADES - 2ª DIAGNOSTICA ', '', regex=False
            )
    ...
    def get_option_answers(self):
        ...
        return textual_answers.values(
            ...
            "question_order", "subject_name", "exam_id", "exam_name", 
    ...
    def get_exam_questions(self):
        ...
        return exam_questions.values(
            ...
            "subject_order", "subject_name", "topics",
        )
    ...
    def handle(self, *args, **kwargs):
        #A tabela de TRI deve ser removida do BQ antes de rodar esse comando

        tmp_directory = os.path.join('tmp', 'parquet')
        os.makedirs(tmp_directory, exist_ok=True)

        print(f'Processando respostas da AVHA 2')
        ...
        answers_remote_name = 'parquet/avha/answers_5bbe72b2-7a16-4f8c-969f-554a67719c87.parq'
        ...
        questions_remote_name = 'parquet/avha/questions_5bbe72b2-7a16-4f8c-969f-554a67719c87.parq'
        ...
        bigquery_service.load_from_parquet(
            answers_remote_name,
            'fiscallize.avha.answers_5bbe72b2-7a16-4f8c-969f-554a67719c87'
        )

        bigquery_service.load_from_parquet(
            questions_remote_name,
            'fiscallize.avha.examquestions_5bbe72b2-7a16-4f8c-969f-554a67719c87'
        )
        ...
        subjects = {
            '2 ano': [
                {'name': 'Matemática', 'std': 54.860737, 'avg': 741.265919},
                {'name': 'Língua Portuguesa', 'std': 62.122713, 'avg': 727.403069},
            ],
            '5 ano': [
        ...
        for grade in subjects.keys():
            for subject in subjects[grade]:
                ...
                tri_remote_name = 'parquet/avha/tri_5bbe72b2-7a16-4f8c-969f-554a67719c87.parq'
                storage_service.upload_file(tri_filename, tri_remote_name)
                bigquery_service.load_from_parquet(
                    tri_remote_name,
                    'fiscallize.avha.tri_5bbe72b2-7a16-4f8c-969f-554a67719c87',
                    append=True,
                )
        ...
        applicationstudents_remote_name = 'parquet/avha/applicationstudents_5bbe72b2-7a16-4f8c-969f-554a67719c87.parq'
        ...
        bigquery_service.load_from_parquet(
            ...
            'fiscallize.avha.applicationstudents_5bbe72b2-7a16-4f8c-969f-554a67719c87'
        )
